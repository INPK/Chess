<template>
  <AuthContainer>
    ...
    <div class="form-group">
      ...
      <div class="form-group__input">
        ...
        />
        <label for="is_agree_with_save_personal_data">Я принимаю договор-оферту и даю согласие на обработку персональных данных</label>
      </div>
    </div>
  ...
  <div class="login-reset" v-else>
    <div class="login-reset__title">Отлично! Осталось подтвердить ваш email. На вашу почту отправлено письмо с подтверждением.</div>
